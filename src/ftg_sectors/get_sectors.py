...
class GetSectors():
    def __init__(self):
        ...
        self.command_pub = rospy.Publisher('/{}/sector'.format("car_8"), Int32, queue_size=1)
        rospy.Subscriber('/{}/particle_filter/viz/inferred_pose'.format("car_8"), PoseStamped, self.mpp_control)
